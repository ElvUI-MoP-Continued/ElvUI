		...
		support = {
			...
			args = {
				git = {
					...
					customWidth = 140,
					func = function() E:StaticPopup_Show("ELVUI_EDITBOX", nil, nil, "https://github.com/ElvUI-MoP/ElvUI-5.4.8/issues") end
				},
				discord = {
					order = 2,
					type = "execute",
					name = L["Discord"],
					customWidth = 140,
					func = function() E:StaticPopup_Show("ELVUI_EDITBOX", nil, nil, "https://discord.gg/UXSc7nt") end
				},
				development = {
					order = 3,
					type = "execute",
					...
					customWidth = 140,
					func = function() E:StaticPopup_Show("ELVUI_EDITBOX", nil, nil, "https://github.com/ElvUI-MoP/ElvUI-5.4.8/archive/master.zip") end
				}
			}
		},
		credits = {
