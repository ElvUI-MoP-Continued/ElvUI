...
L["Add a Name to the list."] = "添加姓名到列表"
...
L["Coloring"] = "着色"
L["Colorize Selected Text"] = "已选择文字着色"
...
L["Cooldown Orientation"] = "冷却方向"
L["Cooldown Text"] = "冷却文字"
L["Cooldowns"] = "冷却"
L["Copy From"] = "复制自"
L["Copy settings from another unit."] = "从其他框架中复制设置"
L["Copy Settings From"] = "复制设置"
L["Core |cff00fcceE|r|cffe5e3e3lvUI|r options."] = "核心|cff00fcceE|r|cffe5e3e3lvUI|r配置"
L["Cosmetic"] = true
L["Count Font"] = true
...
L["Display an exclamation mark on items that starts a quest."] = "在开启任务物品上显示感叹号。"
...
L["Editbox History Size"] = "历史记录框大小"
...
L["If enabled then the filter will activate if the unit is casting anything."] = "启用过滤器后仅在单位释放法术时激活"
L["If enabled then the filter will activate if the unit is channeling anything."] = "启用过滤器后仅在单位引导法术时激活"
L["If enabled then the filter will activate if the unit is not casting anything."] = "启用过滤器后仅在单位未释放法术时激活"
L["If enabled then the filter will activate if the unit is not channeling anything."] = "启用过滤器后仅在单位未引导法术时激活"
...
L["If enabled then the filter will only activate when you have a target."] = "启用过滤器后仅在有目标时激活"
...
L["Number of repeat characters while in combat before the chat editbox is automatically closed. Set to 0 to disable."] = "当你在战斗中按下技能键时,有可能你的输入框还处于打开状态,这个功能可以在你按下技能键并且在输入框中输入下列个数字符串却没有放出技能时帮你自动关闭输入框 Set to 0 to disable."
...
L["Remaining"] = "剩余值"
L["Remove a Name from the list."] = "从列表移除名字"
...
L["Seconds"] = "秒"
L["Selected Text Color"] = "已选文本颜色"
L["Selector Color"] = "选择颜色"
L["Selector Style"] = "选择样式"
...
L["Shortcut to Filters section of the config."] = "一个到过滤器菜单的快捷键"
...
L["Transparent Backdrops"] = "背景不透明度"
L["Transparent Buttons"] = "按键不透明度"
L["Transparent"] = "透明"
L["Triggers"] = "触发器"
L["Trivial"] = "低等级(灰色)"
...
L["ELVUI_DESC"] = "|cff00fcceE|r|cffe5e3e3lvUI|r为一套功能完整, 可用来替换WoW原始界面的套件"
...
L["CHAT_PANEL_TEXTURE_DESC"] = [=[若要设定聊天框背景, 请你指定位于WoW目录下的「Textures」文件夹中的材质文件名.
...
L["PARTY"] = "小队"
L["PET_BATTLE_PVP_QUEUE"] = "宠物对战"
L["PET"] = "宠物"
L["PICKUP_ACTION_KEY_TEXT"] = "提取动作键"
L["PLAYER"] = "玩家"
L["PLAYER_DIFFICULTY1"] = "普通"
L["PLAYER_DIFFICULTY2"] = "英雄"
L["PLAYER_DIFFICULTY3"] = "随机团队"
L["PROFESSIONS_ARCHAEOLOGY"] = "考古学"
...
L["UNIT_NAMEPLATES_TYPE_3"] = "分散姓名板"
L["VOID_STORAGE"] = "虚空仓库"
L["WHISPER"] = "悄悄话"
L["WORLD_MAP"] = "地图"
L["XPBAR_LABEL"] = "经验槽"
...
L["Loot Roll Item Level"] = "战利品掷骰物品等级"
L["Enable/Disable displaying of the item roll item level."] = "启用/禁用显示战利品掷骰的物品等级。"