...
L["Add Instance ID"] = "Добавить ID инстанса"
...
L["Core |cff00fcceE|r|cffe5e3e3lvUI|r options."] = "Основные опции |cff00fcceE|r|cffe5e3e3lvUI|r"
L["Cosmetic"] = true
L["Count Font"] = true
...
L["Enhance Raid Browser"] = "Улучшенные PvP сообщения"
L["Enhance the raid browser frame by adding item level and talent spec information, also add average item level of group information to tooltips."] = "Добавляет специализацию и уровень предметов в список поиска рейдов. Также добавляет средний уровень предметов группы в подсказку."
...
L["If enabled, the style filter will only activate when you are in one of the instances specified in Instance ID."] = "Если включено, фильтр будет активирован только когда вы в одном из инстансов, добавленных в список по ID."
...
L["Number of repeat characters while in combat before the chat editbox is automatically closed. Set to 0 to disable."] = "Кол-во одинаковых символов введенных в бою, после которого поле ввода автоматически закроется. Set to 0 to disable."
...
L["Remove Instance ID"] = "Удалить ID инстанса"
...
L["Support & Download"] = "Поддержка и загрузки"
...
L["Transparent Backdrops"] = "Прозрачный фон"
...
L["ELVUI_DESC"] = "|cff00fcceE|r|cffe5e3e3lvUI|r это аддон для полной замены пользовательского интерфейса World of Warcraft."
...
L["CHAT_PANEL_TEXTURE_DESC"] = [=[Укажите имя файла в папке World of Warcraft, который Вы хотите использовать в качестве фона панелей.
...
L["AUCTIONS"] = "Лоты"
L["BAGSLOT"] = "Сумка"
L["BALANCE_NEGATIVE_ENERGY"] = "Лунная энергия"
L["BALANCE_POSITIVE_ENERGY"] = "Солнечная энергия"
...
L["MOUNTS_AND_PETS"] = "Транспорт и питомцы"
L["NAME"] = "Имя"
L["NONE"] = "Нет"
L["OFFICER"] = "Офицер"
L["OPACITY"] = "Видимость"
...
L["UNIT_NAMEPLATES_TYPE_3"] = "Рядом"
