...
L["ELVUI_DESC"] = "|cff00fcceE|r|cffe5e3e3lvUI|r는 WoW에서 지원하는 대부분의 기능을 대체하는 통합 애드온입니다."
...
L["CHAT_PANEL_TEXTURE_DESC"] = [=[패널 배경에 그림을 입히고 싶으면 위치와 파일명를 이곳에 입력해야 합니다.
...
L["AUCTIONS"] = "경매"
L["BAGSLOT"] = "가방"
L["BALANCE_NEGATIVE_ENERGY"] = "달 에너지"
L["BALANCE_POSITIVE_ENERGY"] = "태양 에너지"
L["BARBERSHOP"] = "미용실"
L["BATTLEFIELDS"] = "전장"
L["BINDING_HEADER_RAID_TARGET"] = "대상 표시기"
L["BLACK_MARKET_AUCTION_HOUSE"] = "암시장 경매장"
L["BURNING_EMBERS"] = "타오르는 불씨"
L["BLOCK"] = "방패 막기"
L["BOSS"] = "우두머리"
...
L["PARTY"] = "파티"
L["PET_BATTLE_PVP_QUEUE"] = "애완동물 대전"
L["PET"] = "소환수"
L["PICKUP_ACTION_KEY_TEXT"] = "행동 단축바 수정 키"
L["PLAYER"] = "플레이어"
L["PLAYER_DIFFICULTY1"] = "일반"
L["PLAYER_DIFFICULTY2"] = "영웅"
L["PLAYER_DIFFICULTY3"] = "공격대 찾기"
L["PROFESSIONS_ARCHAEOLOGY"] = "고고학"
...
L["UNIT_NAMEPLATES_TYPE_3"] = "이름표 좌우 정렬"
