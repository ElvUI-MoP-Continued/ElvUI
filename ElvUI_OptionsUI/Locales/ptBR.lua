...
L["Add a Name to the list."] = "Adicionar um Nome para a lista."
...
L["Clickable Width"] = "Altura clicável"
...
L["Core |cff00fcceE|r|cffe5e3e3lvUI|r options."] = "Opções do núcleo do |cff00fcceE|r|cffe5e3e3lvUI|r"
L["Cosmetic"] = true
L["Count Font"] = true
...
L["Display the name of the unit on the chat bubble."] = "Mostrar o nome da unidade na bolha do chat."
...
L["Enable/Disable the minimap. |cffFF0000Warning: This will prevent you from seeing the consolidated buffs bar, and prevent you from seeing the minimap datatexts.|r"] = "Habilitar/Desabilitar o minimapa. |cffFF0000Perigo: Isso irá impedir que veja a barra de bônus consolidados e os Textos Informativos do minimapa.|r"
...
L["Number of repeat characters while in combat before the chat editbox is automatically closed. Set to 0 to disable."] = "Número de caracteres repetidos enquanto em combate antes da caixa de edição do bate-papo ser automaticamente fechada. Set to 0 to disable."
...
L["Remove a Name from the list."] = "Remove um Nome da lista."
...
L["DATABAR_DESC"] = "Setup das barras de informação no display da tela."
L["DATATEXT_DESC"] = "Configurar a exibição no ecrã (monitor) dos textos de informação."
L["ELVUI_DESC"] = "O |cff00fcceE|r|cffe5e3e3lvUI|r é um Addon completo de substituição da interface original do World of Warcraft."
...
L["CHAT_PANEL_TEXTURE_DESC"] = [=[Especificar o nome de um ficheiro (arquivo) localizado na diretório do WoW. Ficheiros de textura que deseje ter como fundo dos painéis.
...
L["AUCTIONS"] = "Leilões"
L["BAGSLOT"] = "Bolsa"
L["BALANCE_NEGATIVE_ENERGY"] = "Energia Lunar"
L["BALANCE_POSITIVE_ENERGY"] = "Energia Solar"
...
L["BURNING_EMBERS"] = "Brasas Ardentes"
L["BLOCK"] = "Bloquear"
L["BOSS"] = "Chefe"
...
L["DEFAULT"] = "Padrão"
L["DELETE"] = "Excluir"
L["DEMONIC_FURY"] = "Fúria Demoníaca"
L["DISABLE"] = "Desativar"
L["DND"] = "Ocupado"
...
L["GROUP"] = "Grupo"
L["GUILD"] = "Guilda"
L["GUILDCONTROL"] = "Controle da Guilda"
...
L["MOUNTS_AND_PETS"] = "Montarias e Mascotes"
L["NAME"] = "Nome"
L["NONE"] = "Nenhum"
L["OFFICER"] = "Oficial"
L["OPACITY"] = "Opacidade"
...
L["PARTY"] = "Grupo"
L["PET_BATTLE_PVP_QUEUE"] = "Batalha de Mascotes"
L["PET"] = "Ajudante"
L["PICKUP_ACTION_KEY_TEXT"] = "Botão de ação de saquear"
L["PLAYER"] = "Jogador"
L["PLAYER_DIFFICULTY1"] = "Normal"
L["PLAYER_DIFFICULTY2"] = "Heroico"
L["PLAYER_DIFFICULTY3"] = "Loc. de Raides"
L["PROFESSIONS_ARCHAEOLOGY"] = "Arqueologia"
...
L["UNIT_NAMEPLATES_TYPE_3"] = "Placas de identificação espalhadas"
