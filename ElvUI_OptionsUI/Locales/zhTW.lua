...
L["Core |cff00fcceE|r|cffe5e3e3lvUI|r options."] = "核心 |cff00fcceE|r|cffe5e3e3lvUI|r 選項"
L["Cosmetic"] = true
L["Count Font"] = true
...
L["Number of repeat characters while in combat before the chat editbox is automatically closed. Set to 0 to disable."] = "當你在戰鬥中按下技能鍵時,有可能你的輸入框還處於打開狀態,這個功能可以在你按下技能鍵並且在輸入框中輸入下列個數字符串卻沒有放出技能時幫你自動關閉輸入框 Set to 0 to disable."
...
L["Shortcut to Filters section of the config."] = "一個到過濾器功能表的快速鍵"
...
L["ELVUI_DESC"] = "|cff00fcceE|r|cffe5e3e3lvUI|r 為一套功能完整, 可用來替換 WoW 原始介面的 UI 套件."
...
L["CHAT_PANEL_TEXTURE_DESC"] = [=[指定一個在魔獸世界資料夾之中的文件名. 將欲設置為面板背景的材質置於材質資料夾中.
...
L["AUCTIONS"] = "拍賣"
L["BAGSLOT"] = "背包"
L["BALANCE_NEGATIVE_ENERGY"] = "月能"
L["BALANCE_POSITIVE_ENERGY"] = "日能"
L["BARBERSHOP"] = "美容沙龍"
L["BATTLEFIELDS"] = "戰場"
...
L["PARTY"] = "隊伍"
L["PET_BATTLE_PVP_QUEUE"] = "寵物對戰"
L["PET"] = "寵物"
L["PICKUP_ACTION_KEY_TEXT"] = "拖曳快捷列"
L["PLAYER"] = "玩家"
L["PLAYER_DIFFICULTY1"] = "普通模式"
L["PLAYER_DIFFICULTY2"] = "英雄模式"
L["PLAYER_DIFFICULTY3"] = "團隊搜尋器"
L["PROFESSIONS_ARCHAEOLOGY"] = "考古學"
